<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/users/HA611975/WEB/application/index/view/index/casesList.html";i:1577325080;s:65:"/www/users/HA611975/WEB/application/index/view/public/header.html";i:1571726099;s:66:"/www/users/HA611975/WEB/application/index/view/public/navList.html";i:1571797273;s:65:"/www/users/HA611975/WEB/application/index/view/public/footer.html";i:1577340182;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<!-- 客户案例 -->
<div class="main-case citrixDoorVessel">
    <div class="layui-container">
        <div class="layui-col-xs12 citrixCaseName">
            <span class="layui-breadcrumb">
                <?php if(is_array($dataCasesList['cateList']) || $dataCasesList['cateList'] instanceof \think\Collection): $k1 = 0; $__LIST__ = $dataCasesList['cateList'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k1 % 2 );++$k1;?>
                <a href="<?php echo url('index/index/casesList',['id'=>$vo['id']]); ?>" <?php if($id == $vo['id']): ?> style="background: #5fb878;color: #fff!important;" <?php endif; ?>><?php echo $vo['name']; ?></a>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </span>
        </div>
        <div class="layui-row layui-col-space25" id="citrixCasePageHtml">
        ...
        <?php if(!(empty($casesList) || ($casesList instanceof \think\Collection && $casesList->isEmpty()))): ?>
        <div class="citrixPage" id="citrixCasePage"></div>
        <?php endif; ?>
    </div>
</div>
<!-- footer部分 -->
