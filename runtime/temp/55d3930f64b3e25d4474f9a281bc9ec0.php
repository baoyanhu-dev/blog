<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"D:\phpStudy\WWW\majiang/application/index\view\index\DataList.html";i:1577330795;s:65:"D:\phpStudy\WWW\majiang/application/index\view\public\header.html";i:1571726099;s:66:"D:\phpStudy\WWW\majiang/application/index\view\public\navList.html";i:1571797273;s:65:"D:\phpStudy\WWW\majiang/application/index\view\public\footer.html";i:1577335828;}*/ ?>
<!DOCTYPE html >
<html lang="en" >
<head>
    <meta charset="UTF-8">
...
<div class="main-news" >
    <div class="layui-container">
        ...
        <div class="layui-row layui-col-space20" id="citrixDataPageHtml">
            <?php if(is_array($newsData) || $newsData instanceof \think\Collection): $i = 0; $__LIST__ = $newsData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="layui-col-lg6 content">
                <div>
                    ...
                    <p class="detail"><span><?php echo $vo['description']; ?></span><a href="<?php echo url('index/index/Info',['id'=>$vo['id']]); ?>">[查看更多...]</a></p>
        ...
        <div class="citrixPage" id="citrixDataPage"></div>
    </div>
</div>
