<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpStudy\WWW\majiang/application/admin\view\nav_show\publish.html";i:1571725558;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="childrenBody">
    <form class="layui-form layui-form-pane" id="form_array">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="title" autocomplete="off" placeholder="请输入链接名称" class="layui-input" lay-verify="required" <?php if(!(empty($getInfo['title']) || ($getInfo['title'] instanceof \think\Collection && $getInfo['title']->isEmpty()))): ?> value="<?php echo $getInfo['title']; ?>"<?php endif; ?>>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
              <input type="text" name="content" lay-verify="required"  placeholder="请输入导航地址" autocomplete="off" class="layui-input" <?php if(!(empty($getInfo['content']) || ($getInfo['content'] instanceof \think\Collection && $getInfo['content']->isEmpty()))): ?> value="<?php echo $getInfo['content']; ?>"<?php else: ?> value="" <?php endif; ?>>
            </div>
        </div>
    ...
    <script type="text/javascript">
        layui.use(['form','upload'], function()
        {
            ...
            form.on("submit(form_submit)",function(data){
                $.ajax({
                    url:"<?php echo url('admin/navShow/publish'); ?>",
