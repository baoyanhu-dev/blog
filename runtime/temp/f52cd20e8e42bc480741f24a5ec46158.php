<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\phpstudy_pro\WWW\tp.com/application/admin\view\article\index.html";i:1570584985;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="childrenBody">
    <blockquote class="layui-elem-quote">
        <button type="button" class="layui-btn" onclick="publish(this)" data-url="<?php echo url('admin/article/publish'); ?>">新增</button>
    </blockquote> 
        ...
        <table class="layui-table">
            ...
            <tbody id="tb">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="<?php echo $vo['sort']; ?>" class="citrix_sort" onblur="change_table_val('article','id','<?php echo $vo['id']; ?>','sort',this)">
                    </td>
                    <td>
                    ...
                    <td>
                        <button type="button" class="layui-btn layui-btn-xs" onclick="publish(this)" data-url="<?php echo url('admin/article/publish',['id'=>$vo['id']]); ?>">编辑</button>
    ...
    <script type="text/javascript">
        layui.use(['form'], function()
        {
            ...
            $(document).on("click",".infoDelete",function()
            {
                ...
                layer.confirm('您确定要删除吗？', 
                {
                  btn: ['确定','取消']
                    ...
                    $.ajax({
                        url:"<?php echo url('admin/article/infoDelete'); ?>",
                        data:{"id":id},
                        type:'post',
                        async: false,
                        dataType : 'json',
            ...
            $('.batchDelete').click(function(){
                ...
                layer.confirm('您要批量删除当前选中的内容吗？', 
                {
                    ...
                    $.ajax({
                        url:"<?php echo url('admin/article/batchDelete'); ?>"
                        ,type:'post'
        ...
        { 
            var value = $(obj).val();
            $.ajax({
                url:"<?php echo url('admin/article/changeTableVal'); ?>",
