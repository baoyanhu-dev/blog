<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/www/users/HA611975/WEB/application/admin/view/nav_show/index.html";i:1566033494;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body class="childrenBody">
    <blockquote class="layui-elem-quote">
        <button type="button" class="layui-btn" onclick="publish(this)" data-url="<?php echo url('admin/navShow/publish'); ?>">新增</button>
    </blockquote> 
        ...
        <table class="layui-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" value="<?php echo $vo['sort']; ?>" class="citrix_sort" onblur="change_table_val('navShow','id','<?php echo $vo['id']; ?>','sort',this)">
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <?php else: ?>
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="publish(this)" data-url="<?php echo url('admin/navShow/publish',['pid'=>$vo['id']]); ?>">&nbsp;+&nbsp;</button>
                        <?php endif; ?>
                        <button type="button" class="layui-btn layui-btn-xs" onclick="publish(this)" data-url="<?php echo url('admin/navShow/publish',['id'=>$vo['id']]); ?>">编辑</button>
    ...
    <script type="text/javascript">
            ...
            $(document).on("click",".infoDelete",function()
            {
                ...
                layer.confirm('您确定要删除吗？', 
                {
                  btn: ['确定','取消']
                    ...
                    $.ajax({
                        url:"<?php echo url('admin/navShow/infoDelete'); ?>",
                        data:{"id":id},
                        type:'post',
                        async: false,
                        dataType : 'json',
        ...
        { 
            var value = $(obj).val();
            $.ajax({
                url:"<?php echo url('admin/navShow/changeTableVal'); ?>",
